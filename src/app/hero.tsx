      ...
      >
        {banners.map((item, index) => (
          <div key={index} className="w-full flex-shrink-0 relative">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white bg-black/50 px-6 py-6">
        ...
        {banners.map((_, index) => (
          <button
            ...
            className={`w-10 h-2 rounded-xl transition-all ${
              currentIndex === index ? "bg-white w-12" : "bg-gray-500"
            }`}
          />
        ))}
      </div>
